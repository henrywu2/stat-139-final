...
\textcolor{red}{Include descriptions of variables!!}
...
```{r povertyturnout, echo = F, fig.cap = 'Poverty rate vs. turnout rate.'}
...
We check that our hypothesis that the turnout rate can be predicted from county demographics is reasonable by fitting a baseline linear regression model containing all predictors except state and no interaction terms. The model output is shown in Table \@ref(tab:baseline).
